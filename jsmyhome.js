function getWeather1() {
    $.ajax({
        type: "GET",
        url: "http://api.apixu.com/v1/current.json?key=9d8d4547b5694f9d959131520190702&q=Spain",
        success: function (data) {
            try {
                var json = JSON.parse(JSON.stringify(data));
                document.getElementById("img1").innerHTML = "The weather in Spain is: " + json["current"].temp_c + "c";
            } catch (e) {
                document.getElementById("img1").innerHTML = e;
            }
        },
        error: function (jqXHR, textStatus, errorThrown) {
            document.getElementById("img1").innerHTML = jqXHR.status;
        },
        dataType: "json"
    });
}
...
function getWeather2() {
    $.ajax({
        type: "GET",
        url: "http://api.apixu.com/v1/current.json?key=9d8d4547b5694f9d959131520190702&q=France",
        success: function (data) {
            try {
                var json = JSON.parse(JSON.stringify(data));
                document.getElementById("img2").innerHTML = "The weather in France is: " + json["current"].temp_c + "c";
            } catch (e) {
                document.getElementById("img2").innerHTML = e;
            }
        },
        error: function (jqXHR, textStatus, errorThrown) {
            document.getElementById("img2").innerHTML = jqXHR.status;
        },
        dataType: "json"
    });
}
...
function getWeather3() {
    $.ajax({
        type: "GET",
        url: "http://api.apixu.com/v1/current.json?key=9d8d4547b5694f9d959131520190702&q=Italy",
        success: function (data) {
            try {
                var json = JSON.parse(JSON.stringify(data));
                document.getElementById("img3").innerHTML = "The weather in Italy is: " + json["current"].temp_c + "c";
            } catch (e) {
                document.getElementById("img3").innerHTML = e;
            }
        },
        error: function (jqXHR, textStatus, errorThrown) {
            document.getElementById("img3").innerHTML = jqXHR.status;
        },
        dataType: "json"
    });
}
...
function getWeather4() {
    $.ajax({
        type: "GET",
        url: "http://api.apixu.com/v1/current.json?key=9d8d4547b5694f9d959131520190702&q=Malta",
        success: function (data) {
            try {
                var json = JSON.parse(JSON.stringify(data));
                document.getElementById("img4").innerHTML = "The weather in Malta is: " + json["current"].temp_c + "c";
            } catch (e) {
                document.getElementById("img4").innerHTML = e;
            }
        },
        error: function (jqXHR, textStatus, errorThrown) {
            document.getElementById("img4").innerHTML = jqXHR.status;
        },
        dataType: "json"
    });
}
...
function getWeather5() {
    $.ajax({
        type: "GET",
        url: "http://api.apixu.com/v1/current.json?key=9d8d4547b5694f9d959131520190702&q=Germany",
        success: function (data) {
            try {
                var json = JSON.parse(JSON.stringify(data));
                document.getElementById("img5").innerHTML = "The weather in Germany is: " + json["current"].temp_c + "c";
            } catch (e) {
                document.getElementById("img5").innerHTML = e;
            }
        },
        error: function (jqXHR, textStatus, errorThrown) {
            document.getElementById("img5").innerHTML = jqXHR.status;
        },
        dataType: "json"
    });
}
...
function getWeather6() {
    $.ajax({
        type: "GET",
        url: "http://api.apixu.com/v1/current.json?key=9d8d4547b5694f9d959131520190702&q=Netherlands",
        success: function (data) {
            try {
                var json = JSON.parse(JSON.stringify(data));
                document.getElementById("img6").innerHTML = "The weather in Netherlands is: " + json["current"].temp_c + "c";
            } catch (e) {
                document.getElementById("img6").innerHTML = e;
            }
        },
        error: function (jqXHR, textStatus, errorThrown) {
            document.getElementById("img6").innerHTML = jqXHR.status;
        },
        dataType: "json"
    });
}
...
function getWeather7() {
    $.ajax({
        type: "GET",
        url: "http://api.apixu.com/v1/current.json?key=9d8d4547b5694f9d959131520190702&q=Andora",
        success: function (data) {
            try {
                var json = JSON.parse(JSON.stringify(data));
                document.getElementById("img7").innerHTML = "The weather in Andora is: " + json["current"].temp_c + "c";
            } catch (e) {
                document.getElementById("img7").innerHTML = e;
            }
        },
        error: function (jqXHR, textStatus, errorThrown) {
            document.getElementById("img7").innerHTML = jqXHR.status;
        },
        dataType: "json"
    });
}
...
function getWeather8() {
    $.ajax({
        type: "GET",
        url: "http://api.apixu.com/v1/current.json?key=9d8d4547b5694f9d959131520190702&q=Czech",
        success: function (data) {
            try {
                var json = JSON.parse(JSON.stringify(data));
                document.getElementById("img8").innerHTML = "The weather in Czech is: " + json["current"].temp_c + "c";
            } catch (e) {
                document.getElementById("img8").innerHTML = e;
            }
        },
        error: function (jqXHR, textStatus, errorThrown) {
            document.getElementById("img8").innerHTML = jqXHR.status;
        },
        dataType: "json"
    });
}
