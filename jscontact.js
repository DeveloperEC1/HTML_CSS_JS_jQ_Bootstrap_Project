 function myalert() {
     ...
     z = document.getElementById("textarea1").value;
     if (x == "" && y == "" && z == "") {
         alert("אנא הזן אימייל תקין + אנא הזן שם מלא + אנא הזן הודעה");
         return false;
     }
     if (x == "" && y == "") {
         alert("אנא הזן שם מלא + אנא הזן אימייל תקין");
         return false;
     }
     if (y == "" && z == "") {
         alert("אנא הזן אימייל תקין + אנא הזן הודעה");
         return false;
     }
     if (x == "" && z == "") {
         alert("אנא הזן אימייל תקין + אנא הזן שם מלא");
         return false;
     }
     if (x == "") {
